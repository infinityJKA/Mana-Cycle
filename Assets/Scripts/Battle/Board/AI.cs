...
namespace Battle.Board {
    public struct BestPlacementJob : IJob
    {
        ...
        public BestPlacementJob(GameBoard board, NativeArray<int> bestPlacement, int minCol=0, int maxCol = 7) {
        ...
        public void Execute() {
            for (int i=startOffset; i<startOffset+32; i++) {
                int col = (i/4)%8;
                int rot = i%4;
            ...
            // Debug.Log(bestPlacement[0]+", "+bestPlacement[1]+": "+manaGain+", "+bestPlacement[3]);
        }
